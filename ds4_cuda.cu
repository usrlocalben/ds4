...
static int cuda_q8_f16_cache_has_budget(uint64_t request_bytes, const char *label) {
    ...
    if (limit == UINT64_MAX &&
        ...
        (g_model_range_bytes >= 64ull * 1073741824ull ||
         (g_model_registered && g_model_registered_size >= 64ull * 1073741824ull))) {
        if (g_model_registered && g_model_registered_size >= 112ull * 1073741824ull) {
            limit = 4ull * 1073741824ull;
        } else if ((g_model_registered && g_model_registered_size >= 88ull * 1073741824ull) ||
